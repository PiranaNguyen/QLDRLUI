...
const ClassEvaluationForm = () => {
    ...
    const ids = localStorage.getItem('id'); // Kiểm tra giá trị của biến ids
    console.log("Class ID from localStorage:", ids); // Debug: Kiểm tra giá trị của ids
                    ...
                    <tbody>
                        {evaluations.map(evaluation => (
                            <tr key={evaluation.id}>
                                ...
                                <td>{evaluation.clazz}</td> {/* Hiển thị mã lớp */}
                    ...
                    <Form>
                        ...
                        <Form.Group controlId="formClazz">
                            ...
                            <Form.Control
                                type="text"
                                name="clazz"
                                value={currentEvaluation.clazz = ids}
                                onChange={handleChange}
                                disabled
                            />
                        </Form.Group>
